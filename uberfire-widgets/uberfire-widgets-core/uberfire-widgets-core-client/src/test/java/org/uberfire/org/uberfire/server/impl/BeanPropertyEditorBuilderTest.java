...
import org.uberfire.org.uberfire.server.impl.beans.ComplexPlanBean;
import org.uberfire.org.uberfire.server.impl.beans.SampleEnum;
import org.uberfire.org.uberfire.server.impl.beans.SamplePlanBean;
import org.uberfire.org.uberfire.server.impl.beans.UnknownTypesBean;
...
public class BeanPropertyEditorBuilderTest {
    ...
    public void samplePlanBean_shouldGenerateCategory() throws ClassNotFoundException {
        ...
        PropertyEditorCategory category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.SamplePlanBean"  );
    ...
    public void samplePlanBeanAndInstance_shouldGenerateCategoryAndValues() throws ClassNotFoundException {
        ...
        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
        PropertyEditorCategory category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.SamplePlanBean", new SamplePlanBean( "value1", "value2" ) );
        assertTrue( !category.getFields().isEmpty() );
    ...
    public void complexPlanBean_shouldGenerateCategory() throws ClassNotFoundException {
        ...
        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
        PropertyEditorCategory category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.ComplexPlanBean"  );
        assertTrue( !category.getFields().isEmpty() );
    ...
    public void complexPlanBean_shouldGenerateCategoryAndValues() throws ClassNotFoundException {
        ...
        PropertyEditorCategory category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.ComplexPlanBean", instance );
        assertTrue( !category.getFields().isEmpty() );
    ...
    public void shouldNotGenerateUnhandledTypes() throws ClassNotFoundException {
        ...
        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
        PropertyEditorCategory category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.UnknownTypesBean", new UnknownTypesBean( ) );
        assertTrue( category.getFields().isEmpty() );

        category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.UnknownTypesBean" );
        assertTrue( category.getFields().isEmpty() );
    }
    ...
    public void nullValuesOnInstanceShouldGenerateEmptyStrings() throws ClassNotFoundException {
        ...
        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
        PropertyEditorCategory category = builder.extract( "org.uberfire.org.uberfire.server.impl.beans.SamplePlanBean", new SamplePlanBean( null, null ) );
        assertTrue( !category.getFields().isEmpty() );
