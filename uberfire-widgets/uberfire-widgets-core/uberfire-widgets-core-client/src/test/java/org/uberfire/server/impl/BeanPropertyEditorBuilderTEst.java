...
//import org.uberfire.server.impl.beans.ComplexPlanBean;
//import org.uberfire.server.impl.beans.SampleEnum;
//import org.uberfire.server.impl.beans.SamplePlanBean;
//import org.uberfire.server.impl.beans.UnknownTypesBean;
//
...
//        PropertyEditorCategory category = builder.extract( "org.uberfire.server.impl.beans.SamplePlanBean"  );
...
//
//        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
//        PropertyEditorCategory category = builder.extract( "org.uberfire.server.impl.beans.SamplePlanBean", new SamplePlanBean( "value1", "value2" ) );
//        assertTrue( !category.getFields().isEmpty() );
//
...
//
//        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
//        PropertyEditorCategory category = builder.extract( "org.uberfire.server.impl.beans.ComplexPlanBean"  );
//        assertTrue( !category.getFields().isEmpty() );
//
...
//        PropertyEditorCategory category = builder.extract( "org.uberfire.server.impl.beans.ComplexPlanBean", instance );
//        assertTrue( !category.getFields().isEmpty() );
//
//        PropertyEditorFieldInfo text = category.getFields().get( 0 );
//        PropertyEditorFieldInfo bool = category.getFields().get( 1 );
...
//
//        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
//        PropertyEditorCategory category = builder.extract( "org.uberfire.server.impl.beans.UnknownTypesBean", new UnknownTypesBean( ) );
//        assertTrue( category.getFields().isEmpty() );
//
//        category = builder.extract( "org.uberfire.server.impl.beans.UnknownTypesBean" );
//        assertTrue( category.getFields().isEmpty() );
//    }
//
//
...
//
//        BeanPropertyEditorBuilder builder = new BeanPropertyEditorBuilder();
//        PropertyEditorCategory category = builder.extract( "org.uberfire.server.impl.beans.SamplePlanBean", new SamplePlanBean( null, null ) );
//        assertTrue( !category.getFields().isEmpty() );
//
//        PropertyEditorFieldInfo field1 = category.getFields().get( 0 );
//        PropertyEditorFieldInfo fiedl2 = category.getFields().get( 1 );
