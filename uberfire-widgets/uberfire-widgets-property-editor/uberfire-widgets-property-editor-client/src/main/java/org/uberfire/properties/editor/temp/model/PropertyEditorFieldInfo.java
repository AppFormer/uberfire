package org.uberfire.properties.editor.temp.model;
...
public class PropertyEditorFieldInfo {
    ...
    private PropertyEditorFieldType type;
    ...
    public PropertyEditorFieldType getType() {
        return type;
    }
