...
public class JGitFileSystemProxy implements JGitFileSystem {
    ...
    public JGitFileSystemProxy(Supplier<JGitFileSystem> cachedSupplier) {
    ...
    public String getName() {
        return cachedSupplier.get().getName();
    }
    ...
    public boolean isReadOnly() {
        return cachedSupplier.get().isReadOnly();
    }
