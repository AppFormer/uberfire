...
public class UberfireDocksImplTest {
    ...
    public void testSetup() throws Exception {
        ...
        verify( dockLayoutPanel ).addSouth( docks.southExpanded, docks.southExpanded.widgetSize() );
        verify( dockLayoutPanel ).addEast( docks.eastCollapsed, docks.eastCollapsed.widgetSize() );
        verify( dockLayoutPanel ).addEast( docks.eastExpanded, docks.eastExpanded.widgetSize() );
        verify( dockLayoutPanel ).addWest( docks.westCollapsed, docks.westCollapsed.widgetSize() );
        verify( dockLayoutPanel ).addWest( docks.westExpanded, docks.westExpanded.widgetSize() );
    ...
    public void testPerspectiveChangeEvent() throws Exception {
        ...
        docks.perspectiveChangeEvent( new PerspectiveChange( null, null, "Another" ) );
        ...
        docks.perspectiveChangeEvent( new PerspectiveChange( null, null, "Home" ) );
