...
import org.uberfire.client.workbench.panels.impl.CustomSimpleWorkbenchPanelPresenter;
...
public class StandaloneEditorPerspective extends AbstractWorkbenchPerspectiveActivity {
    ...
    public PerspectiveDefinition getDefaultPerspectiveLayout() {
        final PerspectiveDefinition p = new PerspectiveDefinitionImpl( CustomSimpleWorkbenchPanelPresenter.class.getName() );
