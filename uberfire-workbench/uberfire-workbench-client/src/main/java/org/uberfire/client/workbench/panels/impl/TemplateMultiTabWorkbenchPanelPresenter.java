 ...
 */
@Dependent
public class TemplateMultiTabWorkbenchPanelPresenter extends BaseMultiPartWorkbenchPanelPresenter {

    private SimplePanel container;

    @Inject
    public TemplateMultiTabWorkbenchPanelPresenter( @Named("MultiTabWorkbenchPanelView") final MultiTabWorkbenchPanelView view,
