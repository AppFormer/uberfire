...
public class PartContextMenusViewTest {
    ...
    private PartAndPerspectiveContextMenusView partContextMenusViewWithoutPermission;
    ...
    public void setup() {
        ...
        partContextMenusViewWithoutPermission = new PartAndPerspectiveContextMenusView() {
